  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tender as @tender" do
        ...
        post :create, {:tender => { "title" => "invalid value" }}, valid_session
        expect(assigns(:tender)).to be_a_new(Tender)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tender" do
        ...
        expect_any_instance_of(Tender).to receive(:update).with({ "title" => "MyString" })
        put :update, {:id => tender.to_param, :tender => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tender as @tender" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tender.any_instance.stub(:save).and_return(false)
        put :update, {:id => tender.to_param, :tender => { "title" => "invalid value" }}, valid_session
        expect(assigns(:tender)).to eq(tender)
      end
